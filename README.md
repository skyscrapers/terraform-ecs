 ...
 * [`memory_reservation_prometheus`]: String(optional): The memory reservation to prometheus. (default: 100)
 * [`cpu_alertmanager`]: String(optional): The cpu dedicated to alertmanager. (default: 0)
 * [`memory_alertmanager`]: String(optional): The memory dedicated to alertmanager. (default: 100)
 * [`memory_reservation_alertmanager`]: String(optional): The memory reservation to alertmanager. (default: 100)
 * [`cpu_cloudwatch_exporter`]: String(optional): The cpu dedicated to cloudwatch_exporter. (default: 0)
 * [`memory_cloudwatch_exporter`]: String(optional): The memory dedicated to cloudwatch_exporter. (default: 200)
 * [`memory_reservation_cloudwatch_exporter`]: String(optional): The memory reservation to cloudwatch_exporter. (default: 100)
 * [`cpu_grafana`]:String(optional): The cpu dedicated to grafana. (default: 0)
 * [`memory_grafana`]:String(optional): The memory dedicated to grafana. (default: 100)
 * [`memory_reservation_grafana`]:String(optional): The memory reservation to grafana. (default: 100)
 * [`version_prometheus`]: String(optional): The version of the prometheus docker image . (default: v2.4.0)
