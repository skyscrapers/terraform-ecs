 ...
 * [`prometheus_memory`]: String(optional): The memory dedicated to prometheus. (default: 100)
 * [`prometheus_memory_reservation`]: String(optional): The memory reservation to prometheus. (default: 100)
 * [`alertmanager_cpu`]: String(optional): The cpu dedicated to alertmanager. (default: 0)
 * [`alertmanager_memory`]: String(optional): The memory dedicated to alertmanager. (default: 100)
 * [`alertmanager_memory_reservation`]: String(optional): The memory reservation to alertmanager. (default: 100)
 * [`cloudwatch_exporter_cpu`]: String(optional): The cpu dedicated to cloudwatch_exporter. (default: 0)
 * [`cloudwatch_exporter_memory`]: String(optional): The memory dedicated to cloudwatch_exporter. (default: 200)
 * [`cloudwatch_exporter_memory_reservation`]: String(optional): The memory reservation to cloudwatch_exporter. (default: 100)
 * [`grafana_cpu`]:String(optional): The cpu dedicated to grafana. (default: 0)
 * [`grafana_memory`]:String(optional): The memory dedicated to grafana. (default: 100)
 * [`grafana_memory_reservation`]:String(optional): The memory reservation to grafana. (default: 100)
